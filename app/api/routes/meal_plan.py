...
from app.api.dependencies import get_generation_service, get_meal_plan_service, get_settings_service, require_admin
from app.api.models import MealPlanSaveRequest

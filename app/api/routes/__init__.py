...
from app.api.routes.custom_icons import router as custom_icons_router
from app.api.routes.generation import router as generation_router
from app.api.routes.history import router as history_router
from app.api.routes.icon_mappings import router as icon_mappings_router
...
from app.api.routes.weekly_generation import router as weekly_generation_router
